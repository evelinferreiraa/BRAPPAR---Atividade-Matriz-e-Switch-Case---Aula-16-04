...
public class Thread1v extends Thread{
    ...
    public Thread1v(BufferedImage imagem){
        ...
        this.larguraFinal = largura / 6;
        this.alturaInicial = 0;
        this.alturaFinal = altura;
    }
    
    
    public Thread1v(int[][] matriz1, int[][] matriz2, int[][] resultado, int i) {

...
public class Thread2v extends Thread{
    ...
    public Thread2v(BufferedImage imagem){
        ...
        this.larguraInicial = largura / 6;
        this.larguraFinal = largura / 3;
        this.alturaInicial = 0;
        this.alturaFinal = altura;
    }
    
    
    public Thread2v(int[][] matriz1, int[][] matriz2, int[][] resultado, int i) {
    ...
    public void run(){
        ...
        try {
            ...
            Logger.getLogger(Thread1v.class.getName()).log(Level.SEVERE, null, ex);
        }     
    }
}

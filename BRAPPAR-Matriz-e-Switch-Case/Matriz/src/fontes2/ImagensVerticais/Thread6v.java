...
public class Thread6v extends Thread{
    ...
    public Thread6v(BufferedImage imagem){
        ...
        this.larguraInicial = 5 * largura / 6;
    ...
    public Thread6v(int[][] matriz1, int[][] matriz2, int[][] resultado, int i) {
    ...
    public void run(){
        ...
        try {
            ...
            System.out.println("Escrevendo T6");
        } catch (IOException ex) {
            Logger.getLogger(Thread6v.class.getName()).log(Level.SEVERE, null, ex);
        }     
    }
}
